...
function Join() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.info('Submitting form data');
  ...
  return (
    <div className="pt-[50px] p-10 min-h-screen bg-orange-50 flex flex-col items-center">
      <h1 className="text-4xl font-bold text-center mb-8 text-orange-700">
        Join Hindu YUVA at CSUF
      </h1>
      <div className="max-w-xl w-full bg-white rounded-2xl shadow p-8 mb-8">
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <textarea
            ...
            onChange={handleChange}
            placeholder="Your interests or questions"
            rows={3}
            className="border rounded px-4 py-2"
          />
          <button
            type="submit"
            className="bg-orange-600 text-white font-bold py-2 px-6 rounded hover:bg-orange-700 transition"
            disabled={loading}
          >
      ...
      <div className="max-w-xl w-full bg-orange-100 rounded-2xl shadow p-8 text-center">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <a href="mailto:hinduyuva.csufullerton@gmail.com" className="text-orange-700 underline">
            hinduyuva.csufullerton@gmail.com
          </a>{' '}
          or connect on social media:
        </p>
        <div className="flex justify-center gap-6">
          <a
            href="https://www.instagram.com/hinduyuva_csuf/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-orange-700 font-bold hover:text-orange-800"
          >
            Instagram
          </a>
          <a href="#" className="text-orange-700 font-bold hover:text-orange-800">
            Facebook
          </a>
          <a
            href="https://chat.whatsapp.com/BXqWtIOTWIl9Ud8TYDL7Hm"
            target="_blank"
            rel="noopener noreferrer"
            className="text-orange-700 font-bold hover:text-orange-800"
          >
